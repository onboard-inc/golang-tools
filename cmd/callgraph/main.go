...
package main // import "github.com/onboard-inc/golang-tools/cmd/callgraph"
...
import (
	...
	"github.com/onboard-inc/golang-tools/go/callgraph/rta"
	"github.com/onboard-inc/golang-tools/go/callgraph/static"
	"github.com/onboard-inc/golang-tools/go/callgraph/vta"
...
-format    Specifies the format in which each call graph edge is displayed.
           One of:
            ...
            digraph     output suitable for input to
                        github.com/onboard-inc/golang-tools/cmd/digraph.
           ...
           github.com/onboard-inc/golang-tools/go/ssa for more detail.
...
Examples:
  ...
  Show all functions directly called by the callgraph tool's main function:
    ...
    callgraph -format=digraph github.com/onboard-inc/golang-tools/cmd/callgraph |
      digraph succs github.com/onboard-inc/golang-tools/cmd/callgraph.main
`
