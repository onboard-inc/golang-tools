...
func RunWithSuggestedFixes(t Testing, dir string, a *analysis.Analyzer, patterns ...string) []*Result {
	...
	inTools := false
	{
		...
		fr, _ := frames.Next()
		if fr.Func != nil && strings.HasPrefix(fr.Func.Name(), "github.com/onboard-inc/golang-tools/") {
			inTools = true
		}
	}
...
// directory using github.com/onboard-inc/golang-tools/go/packages, runs the analysis on
