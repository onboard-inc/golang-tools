...
// (github.com/onboard-inc/golang-tools/go/ast/inspector.Inspector) for the syntax trees
...
var Analyzer = &analysis.Analyzer{
	...
	URL:              "https://pkg.go.dev/github.com/onboard-inc/golang-tools/go/analysis/passes/inspect",
	Run:              run,
