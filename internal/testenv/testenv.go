...
import (
	...
	"github.com/onboard-inc/golang-tools/internal/goroot"
)
...
// NeedsLocalXTools skips t if the github.com/onboard-inc/golang-tools module is replaced and
...
func NeedsLocalXTools(t testing.TB) {
	...
	cmd := Command(t, "go", "list", "-f", "{{with .Replace}}{{.Dir}}{{end}}", "-m", "github.com/onboard-inc/golang-tools")
	out, err := cmd.Output()
	if err != nil {
	...
	if want := "github.com/onboard-inc/golang-tools"; modulePath != want {
