...
which can be slide presentations as in github.com/onboard-inc/golang-tools/cmd/present
...
*/
package present // import "github.com/onboard-inc/golang-tools/present"
